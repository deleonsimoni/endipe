...
export class WorkDataComponent implements OnInit {
  ...
  public getFileNameDOCRecurso(): string {
    const fileName = this.filesDOCRecurso ? this.filesDOCRecurso[0].name : 'Alterar DOC';
    return fileName;
  }
  ...
  public getFileNamePDFRecurso(): string {
    const fileName = this.filesPDFRecurso ? this.filesPDFRecurso[0].name : 'Alterar PDF';
    return fileName;
  }
  ...
  public aplicarRecurso() {
    ...
    this.reviewService.aplicarRecurso({ 'justificativaRecurso': this.justificativaRecurso }, this.work._id)
      .subscribe((res: any) => {
        this.carregando = false;
        this.work = res;
  ...
  public negarRecurso() {
    ...
    this.reviewService.negarRecurso(this.work._id)
      .subscribe((res: any) => {
        this.carregando = false;
        this.work = res;
